````bash
cp -r /mnt/Festplatte/Server/Minecraft/Server9-Velocity/velocity/plugins/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/luckperms/ && nano /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/luckperms/config.yml
````
````bash
cp -r /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-2/plugins/luckperms/ && cp -r /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-3/plugins/luckperms/ && cp -r /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/luckperms/ && cp -r /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/test-world/plugins/luckperms/ && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/ && wget https://download.luckperms.net/1541/bukkit/loader/LuckPerms-Bukkit-5.4.128.jar && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-2/plugins/ && wget https://download.luckperms.net/1541/bukkit/loader/LuckPerms-Bukkit-5.4.128.jar && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-3/plugins/ && wget https://download.luckperms.net/1541/bukkit/loader/LuckPerms-Bukkit-5.4.128.jar && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/ && wget https://download.luckperms.net/1541/bukkit/loader/LuckPerms-Bukkit-5.4.128.jar && cd /mnt/Festplatte/Server/Minecraft/Server9-Velocity/test-world/plugins/ && wget https://download.luckperms.net/1541/bukkit/loader/LuckPerms-Bukkit-5.4.128.jar
````
