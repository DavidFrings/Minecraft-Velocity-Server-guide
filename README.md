````bash
cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/velocity/plugins/config/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-1/plugins/config/luckperms/ && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/velocity/plugins/config/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-2/plugins/config/luckperms/ && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/velocity/plugins/config/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/project-3/plugins/config/luckperms/ && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/velocity/plugins/config/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/lobby/plugins/config/luckperms/ && cp /mnt/Festplatte/Server/Minecraft/Server9-Velocity/velocity/plugins/config/luckperms/ /mnt/Festplatte/Server/Minecraft/Server9-Velocity/test-world/plugins/config/luckperms/
````
